...
class opts(object):
  def __init__(self):
    ...
    # system
    self.parser.add_argument('--gpus', default='0, 2, 3',
    ...
    self.parser.add_argument("--rank", default=0, type=int, help="""rank of this process:
                        it is set automatically and should not be passed as argument""")
    self.parser.add_argument("--local_rank", default=0, type=int,
                        help="this argument is not used and should be ignored")
    self.parser.add_argument("--dist_url", default="env://", type=str, help="""url used to set up distributed
    ...
    self.parser.add_argument('--input-video', type=str,default='../videos/MOT16-04.mp4',help='path to the input video')
    self.parser.add_argument('--output-format', type=str, default='video', help='video or text')
    self.parser.add_argument('--output-root', type=str, default='../results/MOT16-04', help='expected output root path')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/anhkhoa/Lam_working/human_tracking/mot_data')
