...
class STrack(BaseTrack):
    ...
    def predict(self, warp_matrix = None, warp_mode = None):
    ...
    @staticmethod
    def multi_predict(stracks, warp_matrix = None , warp_mode = None) :
        if len(stracks) > 0:
...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        for itracked, idet in matches:
            ...
            det = detections[idet]
            track.link_score = 1 - dists[itracked][idet] / kalman_filter.chi2inv95[4]
        ...
        for itracked, idet in matches:
            ...
            det = detections[idet]
            track.link_score = ( 1 - dists[itracked][idet] ) / 2
            if track.state == TrackState.Tracked:
